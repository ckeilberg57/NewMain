...
END:VCALENDAR`;
            ...
            appendMessage('Bot', `Please download your appointment here: <span style="display: flex; align-items: center;"><a href="${icsUrl}" download="consultation.ics" style="color: #FF7273;"><img src="images/calendar.png" alt="Calendar" style="width: 16px; height: 16px; margin-right: 5px;">Download .ics</a></span>`);
