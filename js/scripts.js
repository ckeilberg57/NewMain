...
// *scripts.js
   ...
   function createCustomBox(container, imageUrl, button1Text, button2Text, description) {
    ...
    function openIframeWindowHC() {
      ...
      var leftBox = document.createElement('div');
      leftBox.className = 'customBox';
      createCustomHCBox(leftBox, 'images/realwear.png', 'Play Video', 'QR Code', 'Open PDF', 'RealWear HMT-1 on Pexip Infinity');
      boxContainer.appendChild(leftBox);
      ...
      // Add event listeners to the buttons
      secondLeftBox.querySelector('.customButton1').addEventListener('click', function() {
        openVideo('https://www.youtube.com/embed/YDlbIE2mKDA?si=Sk-zElktHh085NvQ');
      });
      ...
      // Add event listeners to the buttons
      thirdLeftBox.querySelector('.customButton1').addEventListener('click', function() {
        openVideo('videos/playback.mp4');
      });

      thirdLeftBox.querySelector('.customButton2').addEventListener('click', function() {
        openPDF('PPs/vmrPlayback.pdf');
      });
    ...
    function openIframeWindowSC() {
      // Store the content generated by openIframeWindowSC
      originalIframeContent = document.getElementById('mainContent').innerHTML;
      var iframeContainer = document.getElementById('customIframeContainer');
      var iframeContent = document.getElementById('customIframeContent');
   ...
   function createCustomSCBox(container, imageUrl, button1Text, button2Text, description) {
     ...
     function openIframeWindowJudicial() {
     // Store the content generated by openIframeWindowJudicial
      originalIframeContent = document.getElementById('mainContent').innerHTML;
      var iframeContainer = document.getElementById('customIframeContainer');
      var iframeContent = document.getElementById('customIframeContent');
      ...
      var leftBox = document.createElement('div');
      leftBox.className = 'customBox';
      createCustomSCBox(leftBox, 'images/secureMeeting.png', 'Play Video', 'PDF Coming Soon', 'Judicial Workflow');
      boxContainer.appendChild(leftBox);
      ...
      // Add event listeners to the buttons
      leftBox.querySelector('.customButton1').addEventListener('click', function() {
        openVideo('https://www.youtube.com/embed/CTw6mKl_uWM?si=UeGgkrRubHRMw0k2');
      });
   ...
   function createCustomJudicialBox(container, imageUrl, button1Text, button2Text, description) {
      var image = document.createElement('img');
      image.src = imageUrl;
    ...
    function openIframeWindowHowTo() {
      // Store the content generated by openIframeWindowHowTo
      originalIframeContent = document.getElementById('mainContent').innerHTML;
      var iframeContainer = document.getElementById('customIframeContainer');
      var iframeContent = document.getElementById('customIframeContent');
      ...
      var leftBox = document.createElement('div');
      leftBox.className = 'customBox';
      createCustomHowToBox(leftBox, 'images/renewCert.png', 'Play Video', 'Open Pexip Docs', 'How To: Renew Infinity Certs');
      boxContainer.appendChild(leftBox);
